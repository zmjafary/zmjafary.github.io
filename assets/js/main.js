    ...
    var imJs = {
        ...
        contactForm: function() {
            $('.rwt-dynamic-form').on('submit', function(e) {
                ...
                form.setAttribute('action', 'https://docs.google.com/forms/d/e/1FAIpQLScggCG_RrB69zjbkoMB8JLTel7FHcuADxNtzAvJaqYCaxYXNQ/formResponse');
                ...
                _self.find('.rn-btn').after('<div class="success-msg"><p> Thank You! We\'ll Be in Touch Soon.</p></div>');
